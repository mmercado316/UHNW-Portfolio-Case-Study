...
- Prospect 4 — pre-liquidity Bay Area tech early employee at a large pre-IPO AI company; mid-career, first-in-family $20M+ wealth; American-born Mexican-American; pre-M1 (qualification stage, no outreach executed). See `prospects/prospect_4.md`.
- Prospect 3 — next-gen wealth recipient, multi-generational US white American, inherited Bay Area tech wealth; post-M1 (first-touch executed, M2 not yet scheduled). See `prospects/prospect_3.md`.
- Prospect 1 — exited tech founder, mid-career, post-acquisition; Indian-American naturalized US citizen; post-M2 (M3 scheduled with spouse). See `prospects/prospect_1.md`.
- Prospect 2 — foreign-born first-gen operator, French-Lebanese, multi-jurisdictional family business; post-M2 (M3 requested by prospect with spouse). See `prospects/prospect_2.md`.
...
| `prospects/prospect_1.md` | Prospect 1 (post-M2). Relationship stage, archetype, Layer 1 highlights, Layer 2 decision log, Layer 3 pattern match, outreach play, provenance ledger. |
| `prospects/prospect_2.md` | Prospect 2 (post-M2). Same structure. |
| `prospects/prospect_3.md` | Prospect 3 (post-M1). Same structure. |
| `prospects/prospect_4.md` | Prospect 4 (pre-M1, qualification stage). Same structure; Direct bucket in provenance ledger is empty by design. |
| `drafts/strategic_memo.md` | Step-2 strategic memo light revision. Compressed AI to one ~80-word paragraph; folded in Oechsli 67% data point; new "What the Prospect File actually solves" section. Pending review. |
| `drafts/opening.md` | Step-3 opening narrative light revision. Updated terminology, prospect count, four-snapshot framing, research-driven cadence + funnel-stage updates. Pending review. |
| `drafts/closing.md` | Step-4 closing revision. Removed v1's three-question structure; replaced with a one-line bridge into Notes & Sources. Pending review. |
| `drafts/extensibility.md` | Step-5 extensibility sidebar revision. Three verticals (Latin American family office, legacy industrial, specialty medical practice) preserved; added a three-sentence bridge at the top. Pending review. |
| `drafts/project_card.md` | Step-6 project card frontmatter rewrite. Updated counts, banker-craft-first summary, reordered techStack and toolCombinations. Pending review. |
| `drafts/notes_and_sources.md` | Step-7 Notes & Sources expansion. 38 entries across four layers (practitioner mental-model, operational craft, AI tooling positions, landscape). URLs verified. Pending review. |
| `drafts/deliverable.mdx` | **Step-8 fresh full draft of the deliverable.** Assembled from all approved drafts plus a new architecture overview and four condensed prospect profiles. 35 sequential citations in Notes & Sources. Pending Mario's end-to-end review. |
...
| `ai-augmented-uhnw-prospecting.mdx` | v1 deliverable. Scaffolding only (~30-40% reusable). Do not edit unless explicitly told. |
