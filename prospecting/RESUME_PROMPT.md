...
Copy everything below the dashed line into a fresh session opened at `/Users/Mario/jpmproject/prospecting/`.
...
**Critical constraints to internalize from the working memory before any output:**

- **No em dashes anywhere.** Commas, periods, parentheses only.
- **Zero firm names in body text** (no JPMorgan, JPM, Morgan Stanley, Goldman, Bessemer, Rockefeller, Cresset, Pathstone, BBH, etc.). Firms appear only in Notes & Sources.
- **Zero individual names in body text** (no Beyer, Grubman, Kochis, Jaffe, Willis, Allison, Oechsli, Bowen, Prince, Mullen, Knapp, duQuesnay). Names appear only in Notes & Sources.
...
- **Naming convention:** Prospect 1, Prospect 2, Prospect 3. Existing Client 1, Existing Client 2, etc. COI 1, COI 2, etc. No fictional names.
- **The piece is a Client Book case study, NOT a prospecting playbook for a specific firm.** Every research finding lands as "this is what the Book captures" or "this is the decision the Book drives," not as top-down methodology.
...
4. Extensibility sidebar (probably survives intact).
5. Project card entry rewrite (banker craft, not toolchain).
6. Notes & Sources expansion.
7. Fresh draft of the deliverable (full file, MDX with frontmatter, treating v1 as scaffolding only).
